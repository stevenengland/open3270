...
namespace StEn.Open3270.TN3270E
{
    public static class TelnetConstants
    {
        ...
        public const int TELCMD_FIRST = xEOF;


        public static readonly string[] TelQuals = {"IS", "SEND"};

        public static readonly string[] TelnetCommands =
        {
        ...
        public static readonly string[] TelnetOptions =
        {
        ...
        public static readonly byte[] FunctionsReq = {IAC, SB, TELOPT_TN3270E, TnHeader.Ops.Functions};
