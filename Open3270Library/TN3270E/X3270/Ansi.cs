...
namespace StEn.Open3270.TN3270E.X3270
{
    ...
    internal class Ansi : IDisposable
    {
        ...
        public bool allow_wide_mode;
        public char ansi_ch;

        private AnsiDelegate[] ansi_fn;
        public bool ansi_insert_mode;

        private bool ansi_reset__first;
        public int appl_cursor;
        public bool auto_newline_mode;
        public byte bg;
        ...
        public int[] csd = {CSD_US, CSD_US, CSD_US, CSD_US};
        ...
        public bool rev_wraparound_mode;
        ...
        public bool saved_allow_wide_mode;
        public bool saved_altbuffer;
        public int saved_appl_cursor;
        public byte saved_bg;
        public int[] saved_csd = {CSD_US, CSD_US, CSD_US, CSD_US};
        public int saved_cset = CS_G0;


        public int saved_cursor;
        public byte saved_fg;
        public byte saved_gr;
        public bool saved_rev_wraparound_mode;
        public bool saved_wide_mode;
        ...
        private readonly object[] st = new object[7];
        ...
        private AnsiState ansi_newline(int ig1, int ig2)
        {
            ...
            telnet.Controller.SetCursorAddress(telnet.Controller.CursorAddress -
                                               telnet.Controller.CursorAddress%telnet.Controller.ColumnCount);
        ...
        {
            var cc = telnet.Controller.CursorAddress%telnet.Controller.ColumnCount; /* current col */
            var mc = telnet.Controller.ColumnCount - cc; /* max chars that can be inserted */
            ...
            ns = mc - nn;
            if (ns != 0)
                telnet.Controller.CopyBlock(telnet.Controller.CursorAddress, telnet.Controller.CursorAddress + nn, ns,
                    true);
        ...
        private AnsiState ansi_cursor_down(int nn, int ig2)
        {
            ...
            if (rr + nn >= telnet.Controller.RowCount)
                telnet.Controller.SetCursorAddress((telnet.Controller.RowCount - 1)*telnet.Controller.ColumnCount +
                                                   telnet.Controller.CursorAddress%telnet.Controller.ColumnCount);
            else
                telnet.Controller.SetCursorAddress(telnet.Controller.CursorAddress + nn*telnet.Controller.ColumnCount);
            held_wrap = false;
        ...
        private AnsiState ansi_erase_in_display(int nn, int ig2)
        {
            ...
            {
                case 0: /* below */
                    telnet.Controller.EraseRegion(telnet.Controller.CursorAddress,
                        telnet.Controller.RowCount*telnet.Controller.ColumnCount - telnet.Controller.CursorAddress, true);
                    break;
                case 1: /* above */
        ...
        {
            var nc = telnet.Controller.CursorAddress%telnet.Controller.ColumnCount;

            switch (nn)
            {
                case 0: /* to right */
                    telnet.Controller.EraseRegion(telnet.Controller.CursorAddress, telnet.Controller.ColumnCount - nc,
                        true);
                    break;
                case 1: /* to left */
                    ...
                    break;
                case 2: /* all */
                    telnet.Controller.EraseRegion(telnet.Controller.CursorAddress - nc, telnet.Controller.ColumnCount,
                        true);
                    break;
            }
            return AnsiState.DATA;
        ...
        {
            var rr = telnet.Controller.CursorAddress/telnet.Controller.ColumnCount; /* current row */
            var mr = scroll_bottom - rr; /* rows left at and below this one */
            ...
            ns = mr - nn;
            if (ns != 0)
                telnet.Controller.CopyBlock(rr*telnet.Controller.ColumnCount, (rr + nn)*telnet.Controller.ColumnCount,
                    ns*telnet.Controller.ColumnCount, true);
        ...
        {
            var rr = telnet.Controller.CursorAddress/telnet.Controller.ColumnCount; /* current row */
            var mr = scroll_bottom - rr; /* max rows that can be deleted */
            int ns; /* rows that are shifting */
            ...
            ns = mr - nn;
            if (ns != 0)
                telnet.Controller.CopyBlock((rr + nn)*telnet.Controller.ColumnCount, rr*telnet.Controller.ColumnCount,
                    ns*telnet.Controller.ColumnCount, true);

            /* Clear the rest of the screen */
            telnet.Controller.EraseRegion((rr + ns)*telnet.Controller.ColumnCount, nn*telnet.Controller.ColumnCount,
                true);
            return AnsiState.DATA;
        }
        ...
        {
            var cc = telnet.Controller.CursorAddress%telnet.Controller.ColumnCount; /* current col */
            var mc = telnet.Controller.ColumnCount - cc; /* max chars that can be deleted */
            int ns; /* chars that are shifting */
            ...
            ns = mc - nn;
            if (ns != 0)
                telnet.Controller.CopyBlock(telnet.Controller.CursorAddress + nn, telnet.Controller.CursorAddress, ns,
                    true);
        ...
        {
            var col = telnet.Controller.CursorAddress%telnet.Controller.ColumnCount;
            int i;
        ...
        {
            var rr = telnet.Controller.CursorAddress/telnet.Controller.ColumnCount; /* current row */
            var np = scroll_top - 1 - rr; /* number of rows in the scrolling
        ...
        private AnsiState ansi_status_report(int nn, int ig2)
        {
            ...
            switch (nn)
            {
                case 5:
                    ...
                    break;
                case 6:
                    ansi_status_cpr = "\033[" + (telnet.Controller.CursorAddress/telnet.Controller.ColumnCount + 1) +
                                      ";" + (telnet.Controller.CursorAddress%telnet.Controller.ColumnCount + 1) + "R";
        ...
        {
            cs_to_change = gnnames.IndexOf(ansi_ch); //strchr(gnnames, ansi_ch) - gnnames;
            return AnsiState.CSDES;
        }

        private AnsiState ansi_cs_designate2(int ig1, int ig2)
        {
            csd[cs_to_change] = csnames.IndexOf(ansi_ch); //strchr(csnames, ansi_ch) - csnames;
            return AnsiState.DATA;
        }
        ...
        private void ansi_scroll()
        {
            ...
            /* Clear the last line */
            telnet.Controller.EraseRegion((scroll_bottom - 1)*telnet.Controller.ColumnCount,
                telnet.Controller.ColumnCount, true);
        }
