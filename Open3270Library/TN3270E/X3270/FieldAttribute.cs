namespace StEn.Open3270.TN3270E.X3270
{
    public static class FieldAttribute
    {
        ...
        public static bool IsModified(byte c)
        {
            return (c & ControllerConstant.FA_MODIFY) != 0;
        }

        public static bool IsNumeric(byte c)
        {
            return (c & ControllerConstant.FA_NUMERIC) != 0;
        }

        public static bool IsProtected(byte c)
        {
            return (c & ControllerConstant.FA_PROTECT) != 0;
        }

        public static bool IsProtectedAt(byte[] buffer, int index)
        {
            return (buffer[index] & ControllerConstant.FA_PROTECT) != 0;
        }
        ...
        public static bool IsIntense(byte c)
        {
