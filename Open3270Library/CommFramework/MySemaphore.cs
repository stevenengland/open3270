...
namespace StEn.Open3270.CommFramework
{
    ...
    internal sealed class MySemaphore
    {
        ...
        private readonly int initialCount; // CFCJR
        ...
        /// </summary>
        /// <returns>
        ///     true if the call returned because
        ...
        /// </summary>
        /// <returns>
        ///     true if the lock was acquired before
        ///     the specified time elapsed; otherwise, false.
        /// </returns>
        ...
        /// </summary>
        /// <returns>
        ///     true if the acquired maxCount slots.
        ///     This method does not return until
        ///     all slots are acquired.
        /// </returns>
        ...
        /// <returns>
        ///     true if maxCount slots are acquired
        ...
        /// <returns>
        ///     true if we released releaseCount
        ///     slots; otherwise false.
        /// </returns>
